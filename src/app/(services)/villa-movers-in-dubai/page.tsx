  ...
  return (
    <main className="z-20 md:mt-[124px] mt-[69px] max-w-[1400px] mx-auto bg-white">
      ...
      <section className="max-w-4xl md:px-0 px-3 mx-auto md:mt-20 mt-80 md:text-xl text-base flex flex-col gap-y-2 b-text">
        ...
        <p>
          From the moment you book a free quote to unloading in your new villa,
          we handle every detail.
        </p>
        <p>
          With experienced movers, proper equipment, and affordable pricing, we
          make your Dubai villa move smooth and worry-free.
        </p>
      </section>
      <ContactSection
        ...
        desc={
          <>
            ...
            dubai. Fill the form and set relex in you villa, We will manage the
            rest.
            <br />
      ...
      >
        ...
        <div className="mt-8 md:text-lg b-text flex flex-col gap-y-2">
          ...
          <p className="">
            ...
            bedrooms in your villa, the travel distance, and any add-on services
            you select, such as storage or post-move cleaning.
          </p>
          <p className="">
          ...
          <p className="">
            For a precise and instant quote, use our villa movers in dubai price
            online estimates tools.
          </p>
          <p className="">Factors affecting your villa moving price include:</p>
          <ul className="border-t border-[#c00000] pt-5">
            ...
            <li>
              <b>Complexity: </b> Stairs, elevator access, or tight corners may
              require more time and manpower, increasing labor charges.
            </li>
          </ul>
        </div>
        ...
        faqs={[
          {
            ...
            answer: (
              <>
                <p>
                  The villa movers in dubai price depends on factors like villa
                  size, distance, and required services.
                </p>
                <p>One truckload can cost you between AED 1000 – AED 1500.</p>
                <p>
                  A 3-bedroom villa move typically runs AED 4,000–5,000 . Luxury
                  or larger villas can cost more.
                </p>
                <p>
                  Nice Movers offers an{" "}
                  <Link href={"/contact-us"}>online estimator</Link> so you can
          ...
          },
          {
            ...
            answer: (
              <>
                <p>
                  Villa movers and packers make the moving process much smoother
                  by handling everything in an organized way.
                </p>
                <p>
                  They label all items clearly, ensuring you face no hassle when
            ...
            answer: (
              <>
                <p>
                  ...
                  Dhabi, our services extend across all UAE emirates — including
                  Sharjah, Ras Al Khaimah, Fujairah, Ajman, and Umm Al Quwain —
                  providing professional villa moving solutions no matter where
                  you&apos;re located.
                </p>
              </>
            ),
          ...
          },
          {
            ...
            answer: (
              <>
                <p>
                  Yes. We cover all Dubai neighborhoods, including Dubai Silicon
                  Oasis, Palm Jumeirah, Arabian Ranches, Jumeirah, Emirates
                  Hills, and more.
                </p>
                <p>
          ...
          },
          {
            ...
            answer: (
              <>
                ...
                <p>
                  We provide complete villa relocation services across the UAE,
                  handling everything from secure packing and careful
                ...
                <p>
                  Our team is highly experienced in handling luxury relocations.
                  We use premium packing methods to safely move high-value items
                  such as designer furniture, artwork, antiques, and delicate
                  décor.
                </p>
                <h4 className="font-medium text-base">Residential Moving</h4>
                <p>
                  Whether you&apos;re shifting to a new apartment, townhouse, or
                  home, our residential moving services ensure a smooth,
                  reliable, and timely transition tailored to your unique needs.
                </p>
              </>
            ),
          },
            ...
            answer: (
              <>
                ...
                <p>
                  ...
                  keep costs low while maintaining high quality. Our competitive
                  pricing has satisfied many clients looking for an affordable
                  move
                </p>
              </>
            ),
      ...
      >
        ...
        <div className="mt-8 md:text-lg text-sm b-text flex flex-col gap-y-2">
          ...
          <ul className="border-t border-[#c00000] pt-5">
            <li>
              <b>&rarr; Dubai Silicon Oasis (DSO): </b> covering villa complexes
              and neighborhoods.
            </li>
            <li>
            ...
            <li>
              <b>&rarr; Jumeirah area: </b> (incl. Palm Jumeirah, Jumeirah Lakes
              Towers) – beachfront and inland villas
            </li>
            <li>
        ...
        desc={
          <>
            ...
            <ul className="max-2-2xl mt-3 text-[#d6d6d6] list-disc pl-5">
              ...
              <li>
                {" "}
                <span className="font-medium">Email/Contact Us</span>: Visit our
                <Link href={"/contact-us"}>website’s contact page</Link> to send
                a message.
              </li>
              <li>
                {" "}
                <span className="font-medium">Get a Free Quote</span>: Fill out
                the online form or click “Get Quote” on our site for an instant
                estimate.
              </li>
            </ul>
          </>
