...
export const metadata: Metadata = {
  ...
  description:
    "Nice Movers is ISO verifed and professional moving company that provide a wide range of moving and packing services in overall UAE at affordable prices. Call to us or get free quote today.",
};
    ...
    <main className="z-20 mt-32">
      <section className="grid md:grid-cols-2 grid-cols-1 lg:px-20 items-center gap-10 py-12 md:px-0 px-3">
        <div>
          ...
          <p className="text-gray-600 mb-2">
            Since our establishment, Nice Movers has been committed to providing
            reliable, efficient, and professional moving and packing services
            throughout the UAE.
          </p>
          <p className="text-gray-600 mb-6">
            We take pride in being one of the leading movers and packers in the
            UAE, delivering seamless relocation solutions for residential,
      ...
      >
        ...
        >
          ...
          <p className="mb-2">
            Whether you&apos;re relocating within Dubai, Sharjah, Ajman, Al Ain,
            Ras Al Khaimah, Fujairah, or anywhere across the UAE, we are just
            one call away.
          </p>
      ...
      >
        ...
        <p className=" b-text mt-3 max-w-2xl mx-auto text-center">
          There is lot of moving and packing companies in UAE but when its comes
          to choosing the best, you have to look and study the company in
          details. Here are some reasons why you should choose us!
        </p>
        ...
        desc={
          <>
            <p className="text-[#d6d6d6] max-w-2xl mt-3">
              If you&apos;re searching for trusted movers and packers near you,
              look no further than Nice Movers UAE. We are now a verified moving
              company that offers moving services at affordable rates.
            </p>
            <p className="text-[#d6d6d6] max-w-2xl mt-3">
              Visit our{" "}
