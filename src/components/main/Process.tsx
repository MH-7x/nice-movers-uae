      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 mt-10">
        <div className="flex items-center justify-center flex-col gap-y-3">
          ...
          <p className="text-sm/4.5 b-text text-center">
            Fill out our free online moving form or call us. Our team will reach
            out with an initial estimate and discuss your needs.
          </p>
        </div>
        <div className="flex items-center justify-center flex-col gap-y-3">
          <div className="w-16 h-16 b-white text-3xl border-[6px] border-[#e7e6e6] font-bold rounded-full b-red-bg flex items-center justify-center">
          ...
          <p className="text-sm/4.5 b-text text-center">
            ...
            understand the size, distance and any special requirements of your
            move.
          </p>
        </div>
        <div className="flex items-center justify-center flex-col gap-y-3">
          ...
          <p className="text-sm/4.5 b-text text-center">
            Review the tailored quote and choose the services you want.Then we
            reserve your moving date and our crew is assigned.
          </p>
        </div>
        <div className="flex items-center justify-center flex-col gap-y-3">
          <div className="w-16 h-16 b-white text-3xl border-[6px] border-[#e7e6e6] font-bold rounded-full b-red-bg flex items-center justify-center">
          ...
          <p className="text-sm/4.5 b-text text-center">
            Our expert movers will handle everything from protecting your home
            during the move to precisely placing your furniture in new space.
          </p>
        </div>
      </div>
    </section>
